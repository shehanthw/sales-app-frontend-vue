    ...
    >
        ...
        <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100">
          <div class="flex justify-between items-center mb-4">
            ...
            <button
              @click="addItem"
              :disabled="false"
              class="text-blue-600 hover:underline cursor-pointer text-sm font-medium"
            >
              + Add Item
            </button>
          </div>
          <div
            ...
            :key="idx"
            class="bg-white p-3 mb-2 rounded-xl border border-gray-200 grid md:grid-cols-12 gap-3 items-center"
          >
            ...
            <div class="md:col-span-2">
              <input
                ...
                type="number"
                min="1"
                class="md:w-full w-14 px-3 py-2 border rounded-lg text-sm"
                :disabled="false"
              />
            </div>
            ...
            <div class="col-span-1 text-right text-sm font-bold text-blue-600">
              <button @click="removeItem(Number(idx))">⛔</button>
            </div>
          </div>
        </div>
      ...
      <div class="p-6 border-t border-gray-100 bg-gray-50">
        ...
        <div class="flex gap-3">
          <button
            @click="$emit('cancel')"
            class="flex-1 px-4 py-3 bg-white border border-gray-200 text-gray-500 font-bold rounded-xl"
          >
            Cancel
          </button>
          <button
            @click="handleSave"
            class="flex-1 px-4 py-3 bg-blue-600 text-white font-bold rounded-xl shadow-lg hover:bg-blue-700"
          >
            Save order
          </button>
        </div>
...
watch(
  [() => props.form.down_payment, () => props.form.items],
  () => {
    calculateBalance();
  },
